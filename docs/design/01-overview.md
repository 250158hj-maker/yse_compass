...
> **更新のしかた**：上書き
> **主担当**：水戸
> **最終更新**：2026-09-06（水戸・1-1〜1-5 を執筆／H-16・H-11 決着を 1-3 へ反映）
...
- **残る未決**：先生ロールの親子二層構造の要否（**#8**）のみ。**ホワイトリストの 1 人目をどう入れるかは 2026-09-06 に決着した**（**H-11** — 運用開始時に DB へ直接投入する 1 回限りの操作とし、以後は画面経由。**ホワイトリストを空にできない**）。**どの層で認可を担保するかは 2026-09-06 に決着した** — 一次防衛線は**データアクセス層**（`../requirements.md` §4 セキュリティ／`09-nfr.md` 9-4）
...
- **新規の未決は起票していない。** 執筆にあたり参照した出典は `../requirements.md` §1・§3-5〜§3-10・§4・§5、`../glossary.md`、`../decisions.md`（2026-07-17／2026-07-26／2026-09-04／2026-09-05）、`../open-questions.md`（#5・#8・#10・H-11・H-12・H-16 ※ H-16・H-11 はいずれも 2026-09-06 に決着）、企画書 §1〜§4
