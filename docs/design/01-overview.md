...
> **更新のしかた**：上書き
> **主担当**：水戸
> **最終更新**：2026-09-06（水戸・1-1〜1-5 を執筆）
...
- **残る未決**：最初のスーパーユーザーがどこから生まれるか（**H-11**）／先生ロールの親子二層構造の要否（**#8**）。どの層で認可を担保するかは **H-16**（`09-nfr.md`）
...
- **新規の未決は起票していない。** 執筆にあたり参照した出典は `../requirements.md` §1・§3-5〜§3-10・§4・§5、`../glossary.md`、`../decisions.md`（2026-07-17／2026-07-26／2026-09-04／2026-09-05）、`../open-questions.md`（#5・#8・#10・H-11・H-12・H-16）、企画書 §1〜§4
