...
> **更新のしかた**：上書き
> **主担当**：蒲山
> **最終更新**：2026-09-21（水戸・**採番の衝突を解消＝H-20 → H-29**。同 ID を PR #23「当日タイムテーブルの時刻枠」（2026-09-11 10:48 起票）が先に使っていた。先着優先で本 PR 側を動かした。**問い・影響・効く先・先行方針は変更していない**）／2026-09-21（水戸・**ER 直結の未決に H-29 を追加**＝所属関係の成立手段が未定義。`../open-questions.md` からの伝播）／2026-09-04（水戸）
