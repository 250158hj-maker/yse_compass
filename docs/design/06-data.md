...
> **更新のしかた**：上書き
> **主担当**：蒲山
> **最終更新**：2026-09-21（水戸・**H-29 決着を反映**＝所属関係はチームのメンバー行で表す。氏名必須・利用者への参照は任意・**メールアドレスの列は持たない**。ER 直結の未決から H-29 を削除。`../decisions.md` 2026-09-21 の 2 行／**同日に ER 直結の未決へ H-29 を追加**＝所属関係の成立手段が未定義）／2026-09-04（水戸）
