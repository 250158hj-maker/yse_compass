...
> **最終更新**：2026-09-25（蒲山・F-07 を追記＝教室の PC の Wi-Fi 接続管理で、各教室が独立した Wi-Fi を持つことを確認。`open-questions.md` H-28 の出典。あわせて F-04 に追記＝OAuth 疎通検証は校内 PC・校内 Wi-Fi から実施したもので、実証されたのは `localhost` 構成での外向き到達性のみ）
